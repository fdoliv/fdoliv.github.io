...
Now, I'm M.Sc. candidate in Computer Science at Informatics Center of the Federal University of Pernambuco - ([Cin UFPE](https://www.cin.ufpe.br){:target="_blank"}) and member of group Modeling of Distributed and Concurrent Systems ([MoDCS](http://www.modcs.org/){:target="_blank"}). I'm also developer and mantainer of the [Mercury Modeling Tool](http://www.modcs.org/?p=2264){:target="_blank"}.
